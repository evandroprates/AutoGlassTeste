...
using AutoMapper;
using Autofac;
using AutoGlassTeste.Infraestrutura.CrossCuting.IOC;
...
namespace AutoGlassTeste
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<Context>(option => option.UseSqlServer(connection));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "AutoGlassTeste v1"));
            }
